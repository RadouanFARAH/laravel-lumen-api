...
use Aws\AwsClient;
use Dohone\DohonePayServiceProvider;
...
$app->register(NotificationChannels\AwsSns\SnsServiceProvider::class);
$app->register(Illuminate\Mail\MailServiceProvider::class);
$app->register(NotificationServiceProvider::class);
$app->register(FCMServiceProvider::class);
$app->register(DohonePayServiceProvider::class);
