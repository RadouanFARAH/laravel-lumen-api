...
<body>
    ...
    <span class="header_text"> @lang('notifications.demande_envoyee_failed.email.header') </span>

    <div class="header">
        <img src="https://file.innov237.com/logo.jpeg" class="imgheader" />
    </div>

    <h3> @lang('notifications.demande_envoyee_failed.email.title') </h3>
    <p>
        <div>
             @lang('notifications.demande_envoyee_failed.email.body', ['name' => $name]) 
        </div>
        <button class="btn"> @lang('notifications.demande_envoyee_failed.email.button') </button>
    </p>
