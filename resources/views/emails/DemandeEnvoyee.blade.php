...
<body>
    ...
    <span class="header_text">@lang('notifications.demande_envoyee_email.email.header') </span>

    <div class="header">
        <img src="https://file.innov237.com/logo.jpeg" class="imgheader" />
    </div>

    <h3>@lang('notifications.demande_envoyee_email.email.title', ['source' => $source, 'destination' => $destination]) </h3>
    <p>
        <div>
            @lang('notifications.demande_envoyee_email.email.body', ['name' => $name, 'destinataire' => $destinataire]) 
        </div>
        <button class="btn">@lang('notifications.demande_envoyee_email.email.button') </button>
    </p>
